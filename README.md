...
This git includes:
- R package for reproducing or adapting the analysis proposed (minIONLogReg.Rproj)
- The main code in R (using the package) to repeat the analysis or adapt it to your data (main_minIONLogReg.r)
- The 'Pipeline' files, R-nootbooks for reproducing the figures in the manuscript. 
